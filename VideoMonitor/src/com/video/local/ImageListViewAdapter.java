...
public class ImageListViewAdapter extends BaseAdapter {
	...
	public ImageListViewAdapter(Context context, List<LocalFileItem> list) {
		super();
		this.mList = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (this.mList != null) {
			...
			List<HashMap<String, Object>> imageViewList = mList.get(position).itemViews;
			
			if (holder.textView != null) {
				holder.textView.setText(fileItem.fileName);
			}
			if (holder.gridView != null) {
				ImageGridViewAdapter gridViewAdapter = new ImageGridViewAdapter(mContext, imageViewList);
