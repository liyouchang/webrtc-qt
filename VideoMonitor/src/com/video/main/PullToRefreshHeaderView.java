...
public class PullToRefreshHeaderView extends LinearLayout {
	 ...
	 * 下拉刷新终端
	 */
	private TextView mHeaderUpdateTerminal;
	/**
	 * footer refresh time
	 */
...
//	private String mLastUpdateTime;
	...
	private void addHeaderView() {
		...
		mHeaderUpdateTerminal = (TextView) mHeaderView.findViewById(R.id.pull_to_refresh_updated_terminal);
...
//			}
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
			...
			mHeaderUpdateTerminal.setVisibility(View.VISIBLE);
	...
	public void onHeaderRefreshComplete(CharSequence lastUpdated, CharSequence terminal) {
	...
	public void setLastUpdated(CharSequence lastUpdated, CharSequence terminal) {
		if (lastUpdated != null) {
			mHeaderUpdateTextView.setVisibility(View.VISIBLE);
			mHeaderUpdateTextView.setText(lastUpdated);
			mHeaderUpdateTerminal.setVisibility(View.VISIBLE);
			mHeaderUpdateTerminal.setText(terminal);
		} else {
			mHeaderUpdateTextView.setVisibility(View.GONE);
			mHeaderUpdateTerminal.setVisibility(View.GONE);
		}
	}
...
//	}
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(PullToRefreshHeaderView pullToRefreshHeaderView);
	}
