...
namespace sigslot {
	...
	public:
		...
		virtual has_slots_interface* getdest() const = 0;
        virtual void emitting(arg1_type) = 0;
	...
	public:
		...
		virtual has_slots_interface* getdest() const = 0;
        virtual void emitting(arg1_type, arg2_type) = 0;
	...
	public:
		...
		virtual has_slots_interface* getdest() const = 0;
        virtual void emitting(arg1_type, arg2_type, arg3_type) = 0;
	...
	public:
		...
		virtual has_slots_interface* getdest() const = 0;
        virtual void emitting(arg1_type, arg2_type, arg3_type, arg4_type) = 0;
	...
	public:
		...
		virtual has_slots_interface* getdest() const = 0;
        virtual void emitting(arg1_type, arg2_type, arg3_type, arg4_type,
			arg5_type) = 0;
	...
	public:
		...
		virtual has_slots_interface* getdest() const = 0;
        virtual void emitting(arg1_type, arg2_type, arg3_type, arg4_type, arg5_type,
			arg6_type) = 0;
	...
	public:
        ...
        virtual void emitting(arg1_type a1)
		{
	...
	public:
        ...
        virtual void emitting(arg1_type a1, arg2_type a2)
		{
	...
	public:
        ...
        virtual void emitting(arg1_type a1, arg2_type a2, arg3_type a3)
		{
	...
	public:
        ...
        virtual void emitting(arg1_type a1, arg2_type a2, arg3_type a3, arg4_type a4,
			arg5_type a5)
		{
	...
	public:
        ...
        void emitting(arg1_type a1, arg2_type a2)
		{
			lock_block<mt_policy> lock(this);
			typename connections_list::const_iterator itNext, it = m_connected_slots.begin();
			typename connections_list::const_iterator itEnd = m_connected_slots.end();
	...
	public:
        ...
        void emitting(arg1_type a1, arg2_type a2, arg3_type a3)
		{
			lock_block<mt_policy> lock(this);
			typename connections_list::const_iterator itNext, it = m_connected_slots.begin();
			typename connections_list::const_iterator itEnd = m_connected_slots.end();
	...
	public:
        ...
        void emitting(arg1_type a1, arg2_type a2, arg3_type a3, arg4_type a4)
		{
			lock_block<mt_policy> lock(this);
			typename connections_list::const_iterator itNext, it = m_connected_slots.begin();
			typename connections_list::const_iterator itEnd = m_connected_slots.end();
	...
	public:
			...
			arg5_type a5, arg6_type a6, arg7_type a7)
		{
			...
			while(it != itEnd)
			{
                ...
                (*it)->emitting(a1, a2, a3, a4, a5, a6, a7);
	...
	public:
			...
			arg5_type a5, arg6_type a6, arg7_type a7, arg8_type a8)
		{
			...
			while(it != itEnd)
			{
                ...
                (*it)->emitting(a1, a2, a3, a4, a5, a6, a7, a8);
			...
			arg5_type a5, arg6_type a6, arg7_type a7, arg8_type a8)
		{
			...
			while(it != itEnd)
			{
                ...
                (*it)->emittingting(a1, a2, a3, a4, a5, a6, a7, a8);
